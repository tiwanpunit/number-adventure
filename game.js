(() => {
  ...
  const MISSION_TYPES = new Set(['build', 'compare', 'missing', 'path', 'split', 'array', 'order', 'tunnel', 'mirror', 'train', 'zeroMagic']);
  ...
  const renderers={build:renderBuild,compare:renderCompare,missing:renderMissing,path:renderPath,split:renderSplit,array:renderArray,order:renderOrder,tunnel:renderTunnel,mirror:renderMirror,train:renderTrain,zeroMagic:renderZeroMagic};
